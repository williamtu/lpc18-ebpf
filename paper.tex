\documentclass[10pt,numbers,reprint]{lpc}
...
\authorinfo{
  ...
  \begin{matrix}
    % Alphabetical order.
    \textrm{William Tu$^1$} & \textrm{Joe Stringer$^2$} & \textrm{Yifeng Sun$^1$} & \textrm{Yi-Hung Wei$^1$}\\
    \textrm{u9012063@gmail.com} & \textrm{joe@cilium.io} & \textrm{pkusunyifeng@gmail.com} & \textrm{yihung.wei@gmail.com} \\
  \end{matrix}
  \)
}
{
